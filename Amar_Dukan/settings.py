...
SECRET_KEY = 'django-insecure-754kc1=u71(cwwf8wx5#0&x+v^+2uvo%xfktl3cp)7nve4)=43'
...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR / "staticfiles"  # python manage.py collectstatic ---> for staticfiles
